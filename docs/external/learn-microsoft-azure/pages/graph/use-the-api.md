...
- [{HTTP method}](https://learn.microsoft.com/en-us/graph/use-the-api#http-methods) \- The HTTP method used on the request to Microsoft Graph.
- [{version}](https://learn.microsoft.com/en-us/graph/use-the-api#version) \- The version of the Microsoft Graph API your application is using.
- [{resource}](https://learn.microsoft.com/en-us/graph/use-the-api#resource) \- The resource in Microsoft Graph that you're referencing.
- [{query-parameters}](https://learn.microsoft.com/en-us/graph/use-the-api#query-parameters) \- Optional OData query options or REST method parameters that customize the response.
- [{headers}](https://learn.microsoft.com/en-us/graph/use-the-api#headers) \- Request headers that customize the request. Can be optional or required depending on the API.
