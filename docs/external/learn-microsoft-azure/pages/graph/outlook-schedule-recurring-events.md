...
| **startDate** | Required | Specifies the date to start applying the pattern. The value of **startDate** MUST correspond to the date value of the **start** property on the [event resource](https://learn.microsoft.com/en-us/graph/api/resources/event). Note that the first occurrence of the meeting might not occur on this date if it does not fit the pattern. |
...
- Find out more about [integrating with Outlook calendar](https://learn.microsoft.com/en-us/graph/outlook-calendar-concept-overview).
- See other recurring event examples in the calendar API reference:
  - [Create a recurring event that occurs once a week](https://learn.microsoft.com/en-us/graph/api/user-post-events#request-3)
  - [Create a daily recurring event](https://learn.microsoft.com/en-us/graph/api/user-post-events#request-4)
