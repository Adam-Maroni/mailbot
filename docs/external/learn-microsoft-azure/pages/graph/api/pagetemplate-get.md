...
Return the metadata for a [pageTemplate](https://learn.microsoft.com/en-us/graph/api/resources/pagetemplate?view=graph-rest-beta) in the templates folder in a [site](https://learn.microsoft.com/en-us/graph/api/resources/site?view=graph-rest-beta).
...
If successful, this method returns a `200 OK` and a [pageTemplate](https://learn.microsoft.com/en-us/graph/api/resources/pagetemplate?view=graph-rest-beta) object in the response body.
...
- [HTTP](https://learn.microsoft.com/en-us/graph/api/pagetemplate-get?view=graph-rest-beta&tabs=http#tabpanel_1_http)
- [JavaScript](https://learn.microsoft.com/en-us/graph/api/pagetemplate-get?view=graph-rest-beta&tabs=http#tabpanel_1_javascript)
...
let pageTemplate = await client.api('/sites/dd00d52e-0db7-4d5f-8269-90060ac688d1/pageTemplates/f6ed8c43-9923-4c6c-ba09-9c32b8f10aeb/microsoft.graph.pageTemplate')
	.version('beta')
	.get();
```
...
- [HTTP](https://learn.microsoft.com/en-us/graph/api/pagetemplate-get?view=graph-rest-beta&tabs=http#tabpanel_2_http)
- [JavaScript](https://learn.microsoft.com/en-us/graph/api/pagetemplate-get?view=graph-rest-beta&tabs=http#tabpanel_2_javascript)
...
- [HTTP](https://learn.microsoft.com/en-us/graph/api/pagetemplate-get?view=graph-rest-beta&tabs=http#tabpanel_3_http)
- [JavaScript](https://learn.microsoft.com/en-us/graph/api/pagetemplate-get?view=graph-rest-beta&tabs=http#tabpanel_3_javascript)
