...
List properties and relationships of the [cloudCertificationAuthority](https://learn.microsoft.com/en-us/graph/api/resources/intune-cloudpkigraphservice-cloudcertificationauthority?view=graph-rest-beta) objects.
...
| --- | --- |
| Delegated (work or school account) | DeviceManagementCloudCA.ReadWrite.All |
| Delegated (personal Microsoft account) | Not supported. |
| Application | DeviceManagementCloudCA.ReadWrite.All |
...
If successful, this method returns a `200 OK` response code and a collection of [cloudCertificationAuthority](https://learn.microsoft.com/en-us/graph/api/resources/intune-cloudpkigraphservice-cloudcertificationauthority?view=graph-rest-beta) objects in the response body.
