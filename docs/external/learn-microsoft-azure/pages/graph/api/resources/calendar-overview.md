...
| [Cancel an event and send a cancellation message.](https://learn.microsoft.com/en-us/graph/api/event-cancel?view=graph-rest-1.0)<br>**Note**: Specify the optional cancellation message in the request body. | POST | /users/{id \| userPrincipalName}/events/{id}/cancel |
| [Update an event.](https://learn.microsoft.com/en-us/graph/api/event-update?view=graph-rest-1.0)<br>**Note**: Specify the event details to update in the [request body](https://learn.microsoft.com/en-us/graph/api/event-update?view=graph-rest-1.0#request-body). | PATCH | /users/{id \| userPrincipalName}/events/{id} |
