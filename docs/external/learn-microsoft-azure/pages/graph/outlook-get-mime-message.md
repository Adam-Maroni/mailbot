...
In either case, your app must have the appropriate [permissions to access](https://learn.microsoft.com/en-us/graph/permissions-reference) the Outlook item or group post in order to apply the get-message or get-attachment operation.
...
- `Content-Type` \- Indicates the media type of the message or a part of the message, represented by a _type_ and _subtype_. It also
...
[getting the message](https://learn.microsoft.com/en-us/graph/api/message-get):
...
You can also get the MIME representation of an Outlook message, if the message has been attached to an Outlook [event](https://learn.microsoft.com/en-us/graph/api/resources/event), [message](https://learn.microsoft.com/en-us/graph/api/resources/message), [task](https://learn.microsoft.com/en-us/graph/api/resources/outlooktask), or group [post](https://learn.microsoft.com/en-us/graph/api/resources/post) that your app can access.

To do that, identify the message attachment, and append the `$value` segment when
[getting that attachment](https://learn.microsoft.com/en-us/graph/api/attachment-get#get-the-raw-contents-of-a-file-or-item-attachment). The following shows a few common ways to access an attachment. See [get attachment](https://learn.microsoft.com/en-us/graph/api/attachment-get#http-request) for more information.
...
- [Get the MIME content of an item attachment](https://learn.microsoft.com/en-us/graph/api/attachment-get#get-the-raw-contents-of-a-file-or-item-attachment) to an event, message, Outlook task, or group post
- [Why integrate with Outlook mail](https://learn.microsoft.com/en-us/graph/outlook-mail-concept-overview)
- [Use the mail API](https://learn.microsoft.com/en-us/graph/api/resources/mail-api-overview) and its [use cases](https://learn.microsoft.com/en-us/graph/api/resources/mail-api-overview#common-use-cases) in Microsoft Graph v1.0
